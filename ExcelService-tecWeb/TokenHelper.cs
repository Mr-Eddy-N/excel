...
public static partial class TokenHelper
{
    ...
    bool UseAppOnlyClaim)
    {
        ...
        Logger.getInstance().WriteLog("ClaimValues:" + id.ClaimsIdClaimValue);
    ...
    {
        Logger.getInstance().WriteLog("UserPrincipal.Identity.IsAuthenticated:" + UserPrincipal.Identity.IsAuthenticated);
        ...
        string samlClaimValue = "")
    {
        ...
        //}
        Logger.getInstance().WriteLog("SAML: " + samlClaimType + "value:" + samlClaimValue + " add:" + addSamlClaim);
        if (addSamlClaim)
    ...
    public static string SharePointPrincipal = "00000003-0000-0ff1-ce00-000000000000";
